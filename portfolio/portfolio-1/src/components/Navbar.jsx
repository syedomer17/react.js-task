    ...
    <>
      <div className="fixed top-0 left-0 w-full bg-gradient-to-r from-[#0f172a] via-[#1e293b] to-[#0f172a] bg-opacity-90 backdrop-blur-md shadow-lg z-50">
        <div className="max-w-[1300px] mx-auto flex justify-between items-center px-12 h-20 text-white">
          ...
          <a
            href="#"
            className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 hover:from-purple-500 hover:to-blue-400 transition-all duration-500"
          >
            Syed Omer Ali
          </a>
          ...
          <ul className="hidden md:flex gap-12 text-lg font-medium">
            {["About", "Portfolio", "Contact"].map((item, index) => (
              <li key={index} className="relative group cursor-pointer">
                ...
                <span className="absolute left-0 bottom-[-5px] w-0 h-[3px] bg-gradient-to-r from-blue-400 to-purple-500 transition-all duration-500 group-hover:w-full shadow-lg group-hover:shadow-blue-400/50"></span>
              </li>
            ))}
          </ul>
              ...
              <ul className="font-semibold text-4xl space-y-8 text-center text-white">
                {["About", "Portfolio", "Contact"].map((item, index) => (
                  <li key={index} className="relative group cursor-pointer">
                    ...
                    <span className="absolute left-1/2 transform -translate-x-1/2 bottom-[-5px] w-0 h-[3px] bg-gradient-to-r from-blue-400 to-purple-500 transition-all duration-500 group-hover:w-full shadow-lg group-hover:shadow-blue-400/50"></span>
                  </li>
                ))}
              </ul>
            </motion.div>
